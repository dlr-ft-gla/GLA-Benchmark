...
ActiveControlConfigs = {'Controller_Config__FFGLA_Default'};
...
sweepData  = {'Atmosphere.WindConfig.H',     [30 90 150 210 280 350].*0.3048
              'CRM.Actuators.Global_Delay',      [0.03 0.08]
              {'CRM.Actuators.Elevator.w_SO',...     
              'CRM.Actuators.InnerAileron.w_SO',...  
              'CRM.Actuators.OuterAileron.w_SO'}, [8 10 12]
              {'CRM.Actuators.Elevator.d_SO',...     
              'CRM.Actuators.InnerAileron.d_SO',...  
              'CRM.Actuators.OuterAileron.d_SO'}, [0.65 0.8 0.95]
              'LIDAR.Instrument.PAP',            [0.035 0.05 0.065]};
          
sweepType = 1; % 1 = cross, 2 = parallel

control_configs_list = ActiveControlConfigs;

load_type_list = {'CS25_341a'};

ResultsDirectoryFullPath = ResultsDirectory_Robust;

disp('Simulating Robust CS 25.341a discrete gust encounters: ');
Define_Sweep_and_Perform_Simulations;

Robust_Task_List_DG = listOfTasks;

% Continuous turbulence
sweepData  = {'CRM.Actuators.Global_Delay',      [0.03 0.08]
              {'CRM.Actuators.Elevator.w_SO',...     
              'CRM.Actuators.InnerAileron.w_SO',...  
              'CRM.Actuators.OuterAileron.w_SO'}, [8 10 12]
              {'CRM.Actuators.Elevator.d_SO',...     
...
disp('Simulating Robust CS 25.341b continuous turbulence encounters: ');
Define_Sweep_and_Perform_Simulations;

Robust_Task_List_CT = listOfTasks;
